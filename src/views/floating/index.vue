...
<script lang="ts">
  import { IonPage, IonBackButton, IonButtons, IonContent, IonFab, IonFabButton, IonFabList, IonHeader, IonIcon, IonTitle, IonToolbar } from '@ionic/vue';
  import {
    chevronDownCircle,
  ...
  export default defineComponent({
    components: { IonPage, IonBackButton, IonButtons, IonContent, IonFab, IonFabButton, IonFabList, IonHeader, IonIcon, IonTitle, IonToolbar },
    setup() {
